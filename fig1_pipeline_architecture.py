...
outputs = [
    ...
    (11.8, 1.55, 'Reproducible\nJupyter Notebooks',      'GitHub + Zenodo archive\nMIT / CC BY 4.0'),
]
...
ax.text(7.0, 9.57,
        'Three open data sources are integrated through seven sequential processing modules to produce climate-crime correlations, era-stratified sentiment series, geospatial visualisations, and reproducible notebooks.',
