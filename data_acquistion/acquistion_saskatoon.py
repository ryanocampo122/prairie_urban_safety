"""
Climate Data Acquisition Script — Saskatoon
------------------------------------------
Climate Variability, Urban Crime, and Public Perception Study

This script retrieves, cleans, and aggregates climate data from
Environment and Climate Change Canada (ECCC) for Saskatoon.

Purpose
-------
- Download hourly and daily climate observations (2010–present)
...
-------------------
- Uses a single primary station (Saskatoon) for consistency
...
def clean_and_standardize(df, mapping, timeframe):
    ...
    Notes
    -----
    - Handles inconsistent formatting in ECCC outputs
...
def process_city():
    """
    Execute full climate data pipeline for Saskatoon.
